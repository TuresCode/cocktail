  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 to-blue-500 text-white p-4 sm:p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <Link href="/database-management" className="bg-white text-purple-600 px-4 py-2 rounded-md hover:bg-purple-100 transition-colors w-full sm:w-auto text-center">
          Manage Database
        </Link>
      </div>
